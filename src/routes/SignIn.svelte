<script>
    ...
    const signIn = async (provider) => {
        ...
        if (res) {
            ...
            else notification = 'Welcome back!'
        }
...
<main class="p-6 max-w-md mx-auto">
    ...
    <h1 class="text-center font-bold text-3xl sm:text-4xl mb-6">Sign in</h1>
    ...
    <div class="max-w-md mx-auto">
        ...
        <button class="btn btn-primary w-full" on:click={() => { signIn('email') } }>Sign in with email</button>
        ...
        <button on:click={() => { signIn('github') } } class="flex flex-row items-center justify-center w-full ">
